...
<body>
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<ul id="top_right" class="collapse navbar-collapse nav navbar-nav navbar-right"	style="margin-right: 20px;">
			...
			<li>
				<a href="adminController?method=exit">
		...
		<div class="page_main">
			<script type="text/javascript">
				$("#showUser").click(function(){
					$(".dv_content").attr("src","adminController?method=userList&flag=useful");
				})
				$("#invalid").click(function(){
					$(".dv_content").attr("src","adminController?method=userList&flag=userless");
				})
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/adminController?method=getGoodsType&flag=show");
				})
				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/adminController?method=getGoodsType&flag=add");
				})
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/adminController?method=getGoods&flag=show");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/adminController?method=getGoods&flag=add");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/adminController?method=getAllOrder");
				})
			</script>
